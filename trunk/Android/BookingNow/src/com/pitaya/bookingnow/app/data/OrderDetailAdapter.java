...
public class OrderDetailAdapter extends BaseAdapter {
	...
	protected int getItemViewId(){
		return R.layout.fooditem_waiter;
	}
	...
	private void setupConvertView(final View itemView, final ViewHolder viewHolder){
		...
		viewHolder.nameText.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View v) {
				if(viewHolder.nameText.hasFocus()){
					viewHolder.nameText.clearFocus();
				} else {
					viewHolder.nameText.requestFocus();
				}
			}
