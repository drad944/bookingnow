...
drop table if exists pitaya_authority_resource_detail;
drop table if exists pitaya_role_authority_detail;
drop table if exists pitaya_user_role_detail;
drop table if exists pitaya_resource;
drop table if exists pitaya_authority;
drop table if exists pitaya_role;
drop table if exists pitaya_food_material_detail;
drop table if exists pitaya_material;
drop table if exists pitaya_user;
drop table if exists pitaya_customer;
drop table if exists pitaya_order_food_detail;
drop table if exists pitaya_food;
drop table if exists pitaya_order_table_detail;
drop table if exists pitaya_order;
drop table if exists pitaya_table;
